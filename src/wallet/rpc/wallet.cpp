...
static RPCHelpMan createwallet()
{
    return RPCHelpMan{
        ...
        "Creates and loads a new wallet.\n",
        {
            ...
            {"silent_payments", RPCArg::Type::BOOL, RPCArg::Default{false}, "Enable creating and receiving with a silent payments address."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
    ...
    return RPCHelpMan{"createwalletdescriptor",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            for (bool internal : internals) {
                WalletDescriptor w_desc = GenerateWalletDescriptor(active_hdkey, *output_type, internal);
