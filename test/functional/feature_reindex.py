...
class ReindexTest(BitcoinTestFramework):
    ...
    def assume_valid(self):
        ...
        # Bury that block with roughly two weeks' worth of blocks (2100 blocks)
        for _ in range(2100):
            block_time += 1
            height += 1
        ...
        # Start node0 with -reindex and -assumevalid pointing to the block with invalid signature
        node.stop_node()
        ...
        node.stop_node()
        self.start_node(0, extra_args=["-reindex", "-assumevalid=" + invalid_block.hash, "-minimumchainwork=00000000000000000000000000000000000000000000000000007e01acd42dd2"])
